import{g as p,m as y,d as f,h,a as v}from"./header-2a138bc2.js";async function m(){const t=new Date().getDate();let s=JSON.parse(localStorage.getItem("quoteData"))??{};const r=s.day??0;if(t!==r){const i=await x();i.day=t,localStorage.setItem("quoteData",JSON.stringify(i)),s=i}const o=document.querySelector(".quote-text"),c=document.querySelector(".quote-author");o.textContent=s.quote,c.textContent=s.author}async function x(){try{return(await v.get("https://your-energy.b.goit.study/api/quote")).data}catch{return null}}m();const a={galleryList:document.querySelector(".gallery-list"),defaultText:document.querySelector(".js-hidden-text")};function w(e){return e.map(({_id:t,bodyPart:s,burnedCalories:r,target:o,name:c,time:i})=>`<li data-id="${t}" class="exercise-card ">
